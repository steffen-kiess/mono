...
static int
get_addrlen (struct Mono_Posix_Sockaddr* address, socklen_t* addrlen)
{
	if (!address) {
		*addrlen = 0;
		return 0;
...
int
Mono_Posix_Sockaddr_GetNativeSize (struct Mono_Posix_Sockaddr* address, gint64* size)
{
	socklen_t value;
	int r;
...
int
Mono_Posix_FromSockaddr (struct Mono_Posix_Sockaddr* source, void* destination)
{
	if (!source)
		return 0;
...
int
Mono_Posix_ToSockaddr (void* source, gint64 size, struct Mono_Posix_Sockaddr* destination)
{
...
int
Mono_Posix_Syscall_bind (int socket, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
int
Mono_Posix_Syscall_connect (int socket, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
int
Mono_Posix_Syscall_accept (int socket, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
int
Mono_Posix_Syscall_accept4 (int socket, struct Mono_Posix_Sockaddr* address, int flags)
{
	int r;
...
int
Mono_Posix_Syscall_getpeername (int socket, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
int
Mono_Posix_Syscall_getsockname (int socket, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
gint64
Mono_Posix_Syscall_recvfrom (int socket, void* buffer, guint64 length, int flags, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
gint64
Mono_Posix_Syscall_sendto (int socket, void* message, guint64 length, int flags, struct Mono_Posix_Sockaddr* address)
{
	int r;
...
gint64
Mono_Posix_Syscall_recvmsg (int socket, struct Mono_Posix_Syscall__Msghdr* message, struct Mono_Posix_Sockaddr* address, int flags)
{
	struct msghdr hdr;
	int r;
...
gint64
Mono_Posix_Syscall_sendmsg (int socket, struct Mono_Posix_Syscall__Msghdr* message, struct Mono_Posix_Sockaddr* address, int flags)
{
	struct msghdr hdr;
	int r;
